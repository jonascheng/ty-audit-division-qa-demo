...
#     "answer the question in Traditional Chinese. "
...
DEFAULT_REFINE_PROMPT_TMPL = (
    ...
    "{context_str}\n"
    "------------\n"
    "請根據資料庫檢索新獲得的摘要文件，優化原有答案，以中文回答問題．\n"
    "如果摘要文件不足以優化原有答案，請返回原有答案．請勿捏造答案．\n"
)
...
#     "answer the question in Traditional Chinese.: {question}\n"
#     "Don't try to make up an answer.\n"
# )
DEFAULT_TEXT_QA_PROMPT_TMPL = (
    "資料庫檢索獲得的摘要文件如下：\n"
    ...
    "{context_str}\n"
    "------------\n"
    "請根據資料庫檢索獲得的摘要文件且沒有其他資訊下，以中文回答問題：{question}\n"
...
#     "------------\n"
#     "Given the context information and not prior knowledge, "
#     "answer any questions in Traditional Chinese.\n"
#     "Don't try to make up an answer.\n"
# )
chat_qa_prompt_template = (
    "資料庫檢索獲得的摘要文件如下：\n"
    ...
    "{context_str}\n"
    "------------\n"
    "請根據資料庫檢索獲得的摘要文件且沒有其他資訊下，以中文回答問題．\n"
    "如果摘要文件不足以提供你回答，請說你無法根據資料庫檢索獲得的摘要文件回答任何相關信息．請勿捏造答案．\n"
)
